    ...
    return (
      <div className="header-wrapper">
        ...
        <Link
          ...
          to="/about"
          onClick={this.makeActive.bind(this, '/about')}
        >
          About
        </Link>
        <Link
          className={this.isActive('/developer')}
          to="/developer"
          onClick={this.makeActive.bind(this, '/developer')}
        >
          Developer
        </Link>
        <Link
          ...
          to="/projects"
          onClick={this.makeActive.bind(this, '/projects')}
        >
          Projects
        </Link>
        <Link
          ...
          to="/contact"
          onClick={this.makeActive.bind(this, '/contact')}
        >
          Contact
        </Link>
      </div>
