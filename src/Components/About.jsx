    ...
    return (
      <div className="wrapper about">
        ...
        <div className="about-content">
          ...
          <p>
            I grew up in a small South Carolina town (Sumter), in a home that
            held to traditional Christian values. In high school, I excelled at
            STEM subjects and participated in a collegiate Engineering program.{' '}
          </p>
          ...
          <p>
            ...
            but soon discovered that I wasn't that interested in designing
            parking lots and watersheds, so I switched to Philosophy.{' '}
          </p>

          <p>
            After college I spent two years as a guitarist and sound engineer
            for a church in Clemson. It was there that I met my wife, Emily. We
            ...
            December 2018 and began a Th.M in Old Testament/Septuagint in
            January under Dr. Peter Gentry, one of the foremost Septuatint
          ...
          <p>
            ...
            recording and editing with Logic and ProTools, some network
            tinkering, occasionally moving heavy tables, and reconnecting
            built-in power supplies that should have never been disconnected.
            Through this job I was exposed to programming, specifically but not
          ...
          <p>
            ...
            little Akkadian, Latin, French, and German. In fact, it is my love
            for language that prompted my interest and early success with
            programming languages. My hope is to one day integrate the two by
            teaching Ancient Near Eastern literature and building websites that
            support and disseminate information and material concerning the
            field (e.g.{' '}
            <a
