  ...
  render() {
    return (
      <div className="wrapper developer">
        ...
        <p>In October 2018, I became the site manager for <a href="http://www.philosophipotamus.com" rel="noopener noreferrer" target="_blank">Philosophipotamus</a>, a WordPress site for the philosophical musings of Dr. Mark Coppenger, a professor at The Southern Baptist Theological Seminary. My responsibilities include content management and tinkering with the theme and plugin.</p>

        <p>In December 2018, I accepted a job at <a href="https://www.eltoro.com/" target="_blank" rel="noopener noreferrer">El Toro</a> in Louisville writing React.</p>

        <h2 id="skills">Skills Summary</h2>
        <ul>
          <li><strong>HTML</strong>: Basic HTML, HTML canvas, HTML media playback, Pug templating</li>
          <li><strong>CSS</strong>: Vanilla CSS, Bootstrap, less, Sass</li>
          <li><strong>JavaScript</strong>: Capable in traditional, imperative programming and a familiarity with functional, recursive approaches. Proficiency with AJAX (fetch API, axios). High level proficiency with jQuery, Vue, React, Node, and Express.</li>
          <li><strong>PHP</strong>: Proficiency in native php and an advanced knowledge of Laravel. Familiarity with WordPress CMS and Slim micro-framework.</li>
          <li><strong>C#/.NET</strong>: Intermediate knowledge of C# programming and knowledge of ASP.NET MVC, Entity-Framework, and Linq-to-SQL.</li>
          <li><strong>SQL</strong>: MySQL, SQLite3, Postgres, and SQL Server</li>
          <li><strong>Go</strong>: Strong knowledge and love for Go programming as well as familiarity with Echo.</li>
