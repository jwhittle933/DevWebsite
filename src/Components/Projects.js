    ...
    return (
      <div className="wrapper">
        ...
        <ul>
          ...
          <li><a href="https://github.com/jwhittle933/JonathansJumpnJacks" rel="noopener noreferrer" target="_blank">Jonathan's Jump'n Jacks</a>: A personal fitness app, origianally in native JavaScript, then converted to Vue.js, currently built using React.</li>
          <h4>Freelance</h4>
