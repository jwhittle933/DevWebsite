    ...
    return (
      <div className="wrapper">
        ...
        <ul>
          ...
          <li><a href="https://github.com/jwhittle933/JonathansJumpnJacks" rel="noopener noreferrer" target="_blank">Jonathan's Jump'n Jacks</a>: A personal fitness app, originally in native JavaScript, then converted to Vue.js, currently built using React. Does nutrition calculations and provides the user with daily caloric needs to build muscle, maintain, or burn fat.</li>
          <li><a href="https://github.com/jwhittle933/DevWebsite" rel="noopener noreferrer" target="_blank">This Site</a>: View the code for this page.</li>
          <h4>Freelance</h4>
